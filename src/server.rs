...
impl Server {
    ...
    async fn run_follower_routine(&self) -> cluster_node::Result<()> {
        // TODO: return errors in parallel threads back to main thread.
...
impl cluster_node::ClusterNode for Server {
    ...
    // async fn run_old(&self) -> Result<uuid::Uuid, cluster_node::ClusterNodeError> {
    //     naive_logging::log(self.id, "running...");
